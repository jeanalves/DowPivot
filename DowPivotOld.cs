...
{
    public class DowPivotOld : Indicator
    {
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private DowPivotOld[] cacheDowPivotOld;
		...
		public DowPivotOld DowPivotOld(ISeries<double> input, ZigZagCalculationType calculationType, double strength, bool useHighLow, DrawProperties drawProp, double percentProfitTargetFibo, FiboPivotRetraction fiboPivot)
		{
			...
			return CacheIndicator<DowPivotOld>(new DowPivotOld(){ CalculationType = calculationType, Strength = strength, UseHighLow = useHighLow, DrawProp = drawProp, PercentProfitTargetFibo = percentProfitTargetFibo, FiboPivot = fiboPivot }, input, ref cacheDowPivotOld);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.DowPivotOld DowPivotOld(ZigZagCalculationType calculationType, double strength, bool useHighLow, DrawProperties drawProp, double percentProfitTargetFibo, FiboPivotRetraction fiboPivot)
		{
